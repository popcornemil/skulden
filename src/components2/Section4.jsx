  ...
  return (
    <section id="next-section" className="relative scroll-mt-16 md:scroll-mt-20 overflow-hidden" ref={ref}>
      <div className="absolute inset-0">
        <img src="/city-bg.jpg" alt="" className="w-full h-full object-cover" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-end">
          ...
          <div className={`text-right transition-all duration-1000 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="grid grid-cols-1 gap-6">
              <CityCounter name="Stockholm" label="Reella skulder" debt={86_642_961_377} ratePerMs={300.61 / 1000} />
              <CityCounter name="Göteborg" label="Estimerade skulder" debt={51_000_000_000} ratePerMs={177.36 / 1000} />
              <CityCounter name="Malmö" label="Estimerade skulder" debt={30_000_000_000} ratePerMs={105.21 / 1000} />
            </div>
          </div>
        </div>
      </div>
