    ...
    <section id="contact" className="bg-[#fcfbf9]" ref={ref}>
      <div className="max-w-[1200px] mx-auto w-full grid grid-cols-1 md:grid-cols-2">
        <div className="relative p-6 md:p-[50px]">
          ...
          <h2 className={`font-serif text-[32px] md:text-[48px] font-light text-midnight leading-tight mb-4 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>Ready to Create<br />Better Content?</h2>
          <p className={`font-serif text-[16px] text-midnight/60 transition-all duration-1000 delay-[400ms] ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>From a single screen to a full network — <span className="font-bold">Axxe Studio™</span> gives you the tools to design, manage, and publish content at scale. Get in touch and let's get started.</p>
        </div>
