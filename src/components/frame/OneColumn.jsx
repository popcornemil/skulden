  ...
  return (
    <section className="bg-[#fcfbf9] pt-16 md:pt-20" ref={ref}>
      <div className="max-w-[1200px] mx-auto w-full relative p-6 md:p-[50px]">
        ...
        <h2 className={`font-serif text-[32px] md:text-[48px] lg:text-[64px] font-light text-midnight mb-4 text-center leading-[1.05] transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>The Software Powering<br />Digital Displays</h2>
        <p className={`font-serif text-[16px] text-midnight/60 text-center px-[200px] transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}><span className="font-bold">Axxe Play™</span> is a powerful software platform designed to manage, control, and deliver content across digital screens. Built for reliability, simplicity, and scale. From a single display to a global network — Axxe Play keeps everything in sync.</p>
