...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#fcfbf9] border-t border-b border-midnight/10 mb-5" ref={ref}>
      <div className="max-w-[1200px] mx-auto w-full">
        ...
        <div className="relative px-6 md:px-[50px] text-center">
          <p className={`font-serif text-[14px] text-midnight/40 transition-all duration-1000 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>Dela</p>
